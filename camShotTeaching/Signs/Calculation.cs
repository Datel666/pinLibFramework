using camShotTeaching.Contour;
using camShotTeaching.ImageProcessing;
...
namespace camShotTeaching.Signs
{
    ...
    public static class Calculation
    {
        ...
        {
            var img = new ImageWrapper(source);
        ...
        public static double[] GetOdds(List<Point> points, int s0, int p0, int numTask)
        {
            switch (numTask)
            {
                case 1:
                    return ForOne(points, s0, p0);

                case 2:
                    return ForTwo(points, s0, p0);

                case 3:
                    return ForTree(points, s0, p0);
                case 4:
                    return ForFour(points, p0);

                case 5:
                    return ForFive(points, s0, p0);

                case 6:
                    return ForSix(points, s0, p0);

                case 7:
                    return ForSeven(points, s0, p0);


                default: throw new NotImplementedException("Такого варианта не существует!");
            }
        }
